export const resources = {
  en: {
    translation: {
      ...
      "faq.page.subtitle": "Quick answers to the most asked questions.",
      "faq.admin.new": "New question",
      "faq.admin.createTitle": "New common question",
      "faq.admin.editTitle": "Edit common question",
      "faq.admin.requiredFields": "Question and answer are required.",
      "faq.admin.created": "Common question created.",
      "faq.admin.updated": "Common question updated.",
      "faq.admin.deleted": "Common question deleted.",
      "faq.admin.deleteConfirm": "Delete this common question?",
      "faq.admin.saveFailed": "Failed to save common question.",
      "faq.admin.deleteFailed": "Failed to delete common question.",
      "faq.admin.empty": "No common questions yet.",
      "faq.admin.importDefaults": "Import default questions",
      "faq.admin.imported": "Default common questions imported.",
      "faq.admin.importFailed": "Failed to import default questions.",
      "faq.admin.orderHint": "Lower numbers appear first.",
      "Question translations": "Question translations",
      "Answer translations": "Answer translations",
      Question: "Question",
      Answer: "Answer",
      Order: "Order",
  ...
  ar: {
    translation: {
      ...
      "Tell us what we can improve or what went wrong.":
        "أخبرنا بما يمكننا تحسينه أو ما الذي حدث خطأ.",
      "What is this about?": "بماذا يتعلق هذا؟",
      "Your message": "رسالتك",
      "Share an idea": "شارك فكرة",
      ...
      "faq.page.subtitle": "إجابات سريعة على أكثر الأسئلة شيوعاً.",
      "faq.admin.new": "سؤال جديد",
      "faq.admin.createTitle": "سؤال شائع جديد",
      "faq.admin.editTitle": "تعديل سؤال شائع",
      "faq.admin.requiredFields": "السؤال والإجابة مطلوبان.",
      "faq.admin.created": "تم إنشاء السؤال الشائع.",
      "faq.admin.updated": "تم تحديث السؤال الشائع.",
      "faq.admin.deleted": "تم حذف السؤال الشائع.",
      "faq.admin.deleteConfirm": "حذف هذا السؤال الشائع؟",
      "faq.admin.saveFailed": "فشل حفظ السؤال الشائع.",
      "faq.admin.deleteFailed": "فشل حذف السؤال الشائع.",
      "faq.admin.empty": "لا توجد أسئلة شائعة بعد.",
      "faq.admin.importDefaults": "استيراد الأسئلة الافتراضية",
      "faq.admin.imported": "تم استيراد الأسئلة الشائعة الافتراضية.",
      "faq.admin.importFailed": "فشل استيراد الأسئلة الافتراضية.",
      "faq.admin.orderHint": "الأرقام الأصغر تظهر أولاً.",
      "Question translations": "ترجمات السؤال",
      "Answer translations": "ترجمات الإجابة",
      Question: "السؤال",
      Answer: "الإجابة",
      Order: "الترتيب",
  ...
  ku: {
    translation: {
      ...
      "Tell us what we can improve or what went wrong.":
        "پێمان بڵێ چی باشتر بکەین یان چی هەڵە بوو.",
      "What is this about?": "دەربارەی چییە؟",
      "Your message": "پەیامەکەت",
      "Share an idea": "بیرۆکەیەک هاوبەش بکە",
      "Report a bug": "کێشەیەک ڕاپۆرت بکە",
      ...
      "faq.page.subtitle": "وەڵامی خێرا بۆ پرسیارە باوەکان.",
      "faq.admin.new": "پرسیاری نوێ",
      "faq.admin.createTitle": "پرسیاری باوێکی نوێ",
      "faq.admin.editTitle": "دەستکاری پرسیاری باو",
      "faq.admin.requiredFields": "پرسیار و وەڵام پێویستن.",
      "faq.admin.created": "پرسیاری باو دروستکرا.",
      "faq.admin.updated": "پرسیاری باو نوێکرایەوە.",
      "faq.admin.deleted": "پرسیاری باو سڕایەوە.",
      "faq.admin.deleteConfirm": "ئەم پرسیارە باوە بسڕدرێتەوە؟",
      "faq.admin.saveFailed": "پاشەکەوتکردنی پرسیاری باو سەرکەوتوو نەبوو.",
      "faq.admin.deleteFailed": "سڕینەوەی پرسیاری باو سەرکەوتوو نەبوو.",
      "faq.admin.empty": "هێشتا هیچ پرسیارێکی باو نییە.",
      "faq.admin.importDefaults": "هاوردەکردنی پرسیارە بنەڕەتییەکان",
      "faq.admin.imported": "پرسیارە بنەڕەتییەکان هاوردە کران.",
      "faq.admin.importFailed": "هاوردەکردنی پرسیارە بنەڕەتییەکان سەرکەوتوو نەبوو.",
      "faq.admin.orderHint": "ژمارە بچووکترەکان سەرەتا دەردەکەون.",
      "Question translations": "وەرگێڕانی پرسیار",
      "Answer translations": "وەرگێڕانی وەڵام",
      Question: "پرسیار",
      Answer: "وەڵام",
      Order: "ڕیزبەندی",
