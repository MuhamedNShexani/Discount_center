  ...
  en: {
    translation: {
      ...
      "Privacy Application def":
        "the software program or web application provided by the Company that you use to access our Service, including the Store Products discount discovery platform.",
      Company: "Company",
      "Privacy Company def":
        "referred to as either 'the Company', 'We', 'Us' or 'Our' in this Agreement, refers to the operator of the Store Products service.",
      Country: "Country",
      ...
      Service: "Service",
      "Privacy Service def":
        "the Store Products application and website for discovering discounts, stores, brands, and products.",
